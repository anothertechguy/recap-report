            ...
            <div className="max-w-md mx-auto rounded-2xl p-1 bg-gradient-to-r from-primary/20 via-white/5 to-primary/20">
              <div className="rounded-xl bg-white/5 backdrop-blur-md p-4">
                <div className="flex flex-col sm:flex-row items-center gap-3">
                  ...
                  <button className="w-full sm:w-auto px-7 py-3.5 rounded-lg bg-primary text-white font-body font-bold text-sm uppercase tracking-wider hover:bg-primary/90 transition-all duration-300 hover:shadow-[0_0_30px_hsl(0_78%_50%/0.4)] group inline-flex items-center justify-center gap-2">
                    Subscribe
